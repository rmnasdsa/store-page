export let status = [false, false, false, false];
const fetchData = () => {
  ...
  let payment_1 = 0, payment_2 = 0, payment_3 = 0, payment_4 = 0;
  let count = 1;
  let sum = 0;
  ...
  const getData = async () => {
    ...
    data.products.map(({ name, cost, des, id }) => {
      ...
      select_product_btn[0].addEventListener('click', () => {
        ...
        if (id == 1) {
          status[0] = true;
          shopping_cart_item[0].style.display = 'block';
          ...
          remove_btn[0].addEventListener('click', () => {
            shopping_cart_item[0].style.display = 'none';
            status[0] = false;
            if (status[0] || status[1] || status[2] || status[3]) {
              sum_btn[3].style.display = 'block';
             
            } else {
              sum_btn[3].style.display = 'none';
              payments[3].innerHTML = '';
            }
            payment_1 = 0;
          })
        }
      ...
      select_product_btn[1].addEventListener('click', () => {
        if (id == 2) {
          status[1] = true;
          shopping_cart_item[1].style.display = 'block';
          ...
          remove_btn[1].addEventListener('click', () => {
            shopping_cart_item[1].style.display = 'none';
            status[1] = false;
            if (status[0] || status[1] || status[2] || status[3]) {
              sum_btn[3].style.display = 'block';
      ...
      select_product_btn[2].addEventListener('click', () => {
        if (id == 3) {
          status[2] = true;
          shopping_cart_item[2].style.display = 'block';
          ...
          remove_btn[2].addEventListener('click', () => {
            shopping_cart_item[2].style.display = 'none';
            status[2] = false;
            if (status[0] || status[1] || status[2] || status[3]) {
              sum_btn[3].style.display = 'block';
      ...
      select_product_btn[3].addEventListener('click', () => {
        if (id == 4) {
          status[3] = true;
          shopping_cart_item[3].style.display = 'block';
          ...
          remove_btn[3].addEventListener('click', () => {
            shopping_cart_item[3].style.display = 'none';
            status[3] = false;
            if (status[0] || status[1] || status[2] || status[3]) {
              sum_btn[3].style.display = 'block';
